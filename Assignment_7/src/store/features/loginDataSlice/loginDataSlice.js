...
const loginSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(getLoginCredentials.pending, (state, action) => {
      // console.log("pending")
      state.loading = true;
    });
    builder.addCase(getLoginCredentials.fulfilled, (state, action) => {
      state.loading = false;
      // console.log("fulfilled",action.payload);
      state.loginCredentials = action.payload;
      state.isSuccess = true;
    });
    builder.addCase(getLoginCredentials.rejected, (state, action) => {
      state.loading = false;
